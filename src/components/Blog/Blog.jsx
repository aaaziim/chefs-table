    ...
    return (
        <>
            <div className='rounded-xl border-gray-100 border-2 p-6'>
                ...
                <h3 className="text-2xl">Ingredients: {ingredients.length}</h3>
                ...
                <button className='px-3 py-2 bg-[#0BE58A] rounded-lg my-4' onClick={() => handleWantToCook(blog)}>Want To Cook</button>
